...
export default function BinanceHistory({setCount} : Props){
  ...
  return <>{Array(10).fill(0).map((item, i) => <OrderInfo key={i} datetime="2023-08-20:20:20" symbol="ETH/USDT" side="buy" leverage={3} price={1010231} quoteQty={11} realizedPnl={0} />)}</>
}